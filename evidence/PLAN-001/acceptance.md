...
- Status: **REVIEW / BLOCKED ON AC4-DWG**
...
| AC4 PDF preview, DXF SVG, DWG real smoke | **BLOCKED: real DWG missing** | `BLOCK-0001`; PDF/DXF/header tests pass |
...
PLAN-001 must not be marked DONE or merged until BLOCK-0001 and independent review are closed.
