...
- פירוט היישום לכל WP נמצא ב־[מסמך 10](10-תוכנית-האוטומציה-המפורטת-WP0-WP6.md).
- עותקי 27 מסמכי המקור נשמרו תחת [`originals-pre-automation-20260813/`](originals-pre-automation-20260813/).
...
- אין H200/GPU/cloud/remote execution, ‏G7/G8 או הוצאה כספית בלי אישור חדש.
- PLAN-003 מזוהה כשלב Geometry מקומי אפשרי בחלק 1, אך implementation שלו אינו כלול ב־WP0–WP6 ודורש PLAN/packet ואישור מפורשים נפרדים.
